            ...
            <div class="car--search--wrapper">
                <form action="{{ route('home.search') }}" method="GET">
                    ...
                    <div class="input--group">
                        ...
                        <div class="form-group">
                            <select class="form-control select-client" name="location_id" >
                                <option value="" {{ Request::get('location_id') ? '' : 'selected' }}>Choose location</option>
                                @foreach($locations as $location)
                                    <option value="{{ $location->id }}" {{ Request::get('location_id') == $location->id ? 'selected' : '' }}>{{ $location->location }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input--group">
                        ...
                        <div class="form-group">
                            <select class="form-control select-client" name="drop_location">
                                <option value="{{ $location->location }}" {{ Request::get('drop_location') ? '' : 'selected' }}>Choose location</option>
                                @foreach($locations as $location)
                                    <option value="{{ $location->location }} " {{ Request::get('drop_location') == $location->location ? 'selected' : '' }}>{{ $location->location }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input--group">
                        ...
                        <div class="date--time">
                            <div class="date">
                                <input type="text" id="date1" name="pickup_date" value="{{ Request::get('pickup_date') }}" class="pick--date" placeholder="1/3/2024" readonly>
                            </div>
                        </div>
                    </div>
                    <!-- input group  -->
                    <div class="input--group last">
                        ...
                        <div class="date--time">
                            <div class="date">
                                <input type="text" id="date2" name="drop_date" class="pick--date" value="{{ Request::get('drop_date') }}" placeholder="1/3/2024" readonly>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                @if($searchCars)
                    ...
                    <ul class="filter--pagination text-center justify-content-center">
                        ...
                        @else
                            <li class="prev">
                                <a href="{{ $searchCars->previousPageUrl() }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                        <path d="M15.0938 19.9201L8.57375 13.4001C7.80375 12.6301 7.80375 11.3701 8.57375 10.6001L15.0938 4.08008" stroke="#292D32" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                </a>
                        ...
                        @for ($i = 1; $i <= $searchCars->lastPage(); $i++)
                            @if ($i == $searchCars->currentPage())
                                <li>
                                    <a href="{{ $searchCars->url($i) }}" class="links active">{{ $i }}</a>
                                </li>
                            @else
                                <li>
                                    <a href="{{ $searchCars->url($i) }}" class="links">{{ $i }}</a>
                                </li>
                            @endif
                        @endfor

                        @if ($searchCars->hasMorePages())
                            <li class="next">
                                <a href="{{ $searchCars->nextPageUrl() }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
