...
@section('content')
    ...
    <!-- start hero area  -->
    <section class="hero--area rent--posi">
        <!-- hero--contents -->
        <div class="hero--contents">
            <h1>We Make Your <span>Car Rental</span> Fast and Easy</h1>
        </div>
        <div class="owl-carousel hero--slider">
            @foreach($cars as $car)
                <div class="item">
                    <div class="car--box">
                        <img src="{{ asset($car->slider_image) }}" alt="{{ $car->alt }}">

                        <div class="car--details">
                            <h3>{{ $car->name }}</h3>
                            <div class="rating--price d-flex align-items-center justify-content-between">
                                <!-- rating  -->
                                <div class="rating">
            ...
            <div class="row">
                <div class="col-lg-6 mt_30">
                    <div class="whoose--options">
                        ...
                        <div class="option">
                            ...
                            <p>We will replace your vehicle rental with another vehicle in our fleet in the event of a mechanical breakdown</p>
                            <p class="op--num">05</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 mt_30">
                    <div class="posi--img--wrapper">
                        ...
                        <img class="choose--car-desktop" src="{{ asset('/') }}frontEnd/assets/images/choose--car.png" alt="">
                        <img class="d-none choose--car-mobile" src="{{ asset('/') }}frontEnd/assets/images/choose--car-mobile.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                                ...
                                <div class="tab--links">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="pills-available-car-tab" data-bs-toggle="pill" data-bs-target="#pills-available-car" type="button" role="tab" aria-controls="pills-available-car" aria-selected="true">Available Cars Only (40)</button>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-all-tab" data-bs-toggle="pill" data-bs-target="#pills-all" type="button" role="tab" aria-controls="pills-all" aria-selected="false">All Cars (210)</button>
                                        </li>
                                    </ul>
                                </div>
                                <!-- sort--links--wrap  -->
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade" id="pills-available-car" role="tabpanel" aria-labelledby="pills-available-car-tab" tabindex="0">
                        <div class="row">
                            @foreach($cars as $car)
                    ...
                    <div class="rent--btn--area text-center mt_60">
                        <a href="{{ route('home.listing') }}" class="button">Rent Car</a>
                    </div>
                </div>
            </div>
        </div>
