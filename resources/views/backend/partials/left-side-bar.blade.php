            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                        ...
                        <span class="side-menu__label">Car</span><i class="angle fa fa-angle-right"></i>
                    </a>
                    <ul class="slide-menu">
                        <li class="side-menu-label1"><a href="javascript:void(0)">Car</a></li>
                        <li><a href="{{ route('bookings.index') }}" class="slide-item">Booking</a></li>
                        <li><a href="{{ route('cars.index') }}" class="slide-item">Car</a></li>
                        <li><a href="{{ route('locations.index') }}" class="slide-item">Location</a></li>
                        <li><a href="{{ route('car-types.index') }}" class="slide-item">Car Type</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('dynamic-page.index') }}" class="slide-item">Dynamic Page</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('faqs.index')}}">
